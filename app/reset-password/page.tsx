...
function ResetPasswordForm() {
  ...
  useEffect(() => {
    ...
    const validateToken = async () => {
      try {
        ...
        setTokenError('Network error while validating reset link.');
      } finally {
        setIsLoadingToken(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitError('Network error during password reset.');
    ...
    <>
      {tokenError ? (
        <div style={{ textAlign: 'center', padding: '12px 0' }}>
          ...
          <Link href="/forgot-password" className="btn btn-primary" style={{ width: '100%', padding: '12px' }}>
